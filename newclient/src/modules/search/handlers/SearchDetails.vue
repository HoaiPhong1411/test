...
export default class SearchDetails extends Mixins(NetworkMixin) {
    $refs!: {
        search: SearchRef
    }
    /*
  ...
  */
    ...
    isValidHash(param): boolean {
        return eth.isValidHash(this.removeSpaces(param)) || eth.isValidAddress(this.removeSpaces(param), this.isTrx)
    }
    /**
