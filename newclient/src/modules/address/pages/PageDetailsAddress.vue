                    ...
                    <keep-alive>
                        <div>
                            <v-layout :class="subMenuClass" row wrap align-center justify-start pt-2>
                                <v-btn
                                    v-if="!isTrx"
                                    :class="[toggleERC20 === 0 ? 'active-button' : 'button', 'pl-3 text-capitalize']"
                                    flat
                                    small
                                    @click="toggleERC20 = 0"
                                >
...
import { NetworkMixin } from '@app/core/components/mixins/network.mixin'
...
export default class PageDetailsAddress extends Mixins(AddressUpdateEvent, NetworkMixin) {
    /*
    ===================================================================================
      Props
    ===================================================================================
   */
    ...
    */
    ...
    get isValid(): boolean {
        return eth.isValidAddress(this.addressRef, this.isTrx)
    }
    ...
    get tabs(): Tab[] {
        const tabs: Tab[] = [
            ...
            {
                id: 1,
                title: this.isTrx ? this.$i18n.t('token.trc20') : this.$i18n.t('token.erc20'),
                isActive: false
            },
            {
                id: 2,
