                ...
                <v-layout grid-list-xs row wrap align-center justify-start fill-height class="pt-3 pb-3 pr-3 pl-3">
                    ...
                    <v-flex xs6 pa-1>
                        <p :class="transferValueClass">
                            ...
                            {{ isTrx ? $t('common.trx') : $t(`common.${transferValue.unit}`) }}
                            <app-tooltip
                                v-if="transferValue.tooltipText"
                                :text="`${transferValue.tooltipText} ${isTrx ? $t('common.trx') : $t('common.eth')}`"
                            />
                        </p>
                    </v-flex>
                    <!--
                    ...
                    <v-layout row wrap align-center pl-1 pr->
                        <v-flex sm12>
                            <p :class="transferValueClass">
                                ...
                                {{ amountSign }}{{ transferValue.value }} {{ isTrx ? $t('common.trx') : $t(`common.${transferValue.unit}`) }}
                                <app-tooltip
                                    v-if="transferValue.tooltipText"
                                    :text="`${transferValue.tooltipText} ${isTrx ? $t('common.trx') : $t('common.eth')}`"
                                />
...
export default class TableTxsRow extends Mixins(NumberFormatMixin, NetworkMixin) {
    /*
    ===================================================================================
      Props
    ===================================================================================
